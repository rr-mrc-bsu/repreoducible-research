...
par(mar=c(1, 1, 1, 1))
openplotmat()
elpos <- coordinates(c(2, 1, 2, 2))
fromto <- matrix(c(1, 3, 2, 3, 3, 4, 3, 5, 4, 6, 4, 7, 5, 6, 5, 7), ncol=2,
                 byrow=TRUE)
nr <- nrow(fromto)
...
textrect(elpos[2, ], 0.15, 0.05, lab="vignette.Rnw", box.col="gray",
         shadow.col="grey", shadow.size=0, cex=1.5)
...
textrect(elpos[5, ], 0.15, 0.05, lab="simulation.R", box.col="gray",
         shadow.col="darkblue", shadow.size=0, cex=1.5)
textellipse(elpos[6, ], 0.2, 0.1, lab="manuscript.Rnw", box.col="orange",
            shadow.col="red", shadow.size=0, cex=1.5)
textellipse(elpos[7, ], 0.2, 0.1, lab="presentation.Rnw", box.col="orange",
            shadow.col="red", shadow.size=0, cex=1.5)
