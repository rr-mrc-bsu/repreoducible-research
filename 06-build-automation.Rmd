...
'iris.csv' -> 'data-preparation.Rmd'
'data-preparation.Rmd' -> 'analysis.Rmd'
...
## Makefile
If a Makefile is run, a file is compiled if any of its dependencies has 
...
older than the creation time of its dependencies. A Makefile is composed of a 
...
from the prerequisites. In the example above, we could for example write:
```{bash general-makefile, eval=FALSE, echo=TRUE}
analysis.html: analysis.Rmd iris.csv
    Rscript -e "rmarkdown::render(\
	input       = 'docs/analysis.Rmd',\
	output_file = 'analysis.html',\
	output_dir  = 'docs',\
	params      = list(datafile='../data/iris.csv', outputpath = '../output')"
```
