...
To create this branch you run the follwoing git commands
...
You may now add a new chapter simply by plaing a new numbered .Rmd file in
...
You can therefore simply add all changes and coommit them with a short description
of what you did
...
However, in the rop-down menu for 'compare:' cou can now select you new branch.
...
For normal changes, the build should work without any errors. 
...
the gh-pages branch are used to populate the GitHub pages homepage of the project.
This means that the version of the book displayed at [https://rr-mrc-bsu.github.io/reproducible-research/](https://rr-mrc-bsu.github.io/reproducible-research/) should automatically correspond to the version obtained from the last
